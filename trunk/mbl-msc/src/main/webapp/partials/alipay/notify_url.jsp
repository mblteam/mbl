<%@page import="com.mbl.rest.order.biz.OrderRestBiz"%>
<%@page import="com.mbl.rest.order.biz.impl.OrderRestBizImpl"%>
<%
/**
功能：支付宝服务器异步通知页面
版本：3.3
...
如果没有收到该页面返回的success信息，支付宝会在24小时内按一定的时间策略重发通知
//********************************
**/
%>
	...
	if(AlipayNotify.verify(params)){//验证成功
		...
		if(trade_status.equals("TRADE_FINISHED")){
			//判断该笔订单是否在商户网站中已经做过处理
				...
				//如果有做过处理，不执行商户的业务程序
			OrderRestBiz orderRestBiz = new OrderRestBizImpl();
